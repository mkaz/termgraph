...
def test_horiz_rows_no_labels_yields_no_labels():
...
def test_horiz_rows_multiple_series_only_has_label_at_beginning():
    with patch("sys.stdout", new=StringIO()) as output:
        labels = ["2007", "2008", "2009", "2010", "2011", "2012", "2014"]
        data = [
            [183.32, 190.52, 90.0],
        ...
        normal_dat = [
            [99.4279661016949, 103.2415254237288, 49.99999999999999],
...
def test_print_row_prints_correct_block_count():
    with patch("sys.stdout", new=StringIO()) as output:
...
def test_stacked_graph_prints_correct_graph():
    with patch("sys.stdout", new=StringIO()) as output:
        labels = ["2007", "2008", "2009", "2010", "2011", "2012", "2014"]
        data = [
            [183.32, 190.52],
        ...
        normal_data = [
            [48.059508408796894, 50.0],
            [60.971862871927556, 0.0],
...
def test_stacked_graph_different_label_length_prints_correct_graph():
    with patch("sys.stdout", new=StringIO()) as output:
        ...
        assert (
            output
            == "LOOOOOOOOOOOOOOOOOOOOOOOOONG LINE: \x1b[94m▇▇▇▇▇▇▇▇▇▇\x1b[0m\x1b[91m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇\x1b[0m 30.00\nSHORT LINE                       : \x1b[94m▇▇▇▇▇▇▇▇▇▇\x1b[0m\x1b[91m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇\x1b[0m 30.00"
        )


def test_stacked_graph_no_label_prints_no_labels():
    with patch("sys.stdout", new=StringIO()) as output:
        labels = ["2007", "2008", "2009", "2010", "2011", "2012", "2014"]
        data = [
            [183.32, 190.52],
...
def test_chart_prints_correct_chart():
    with patch("sys.stdout", new=StringIO()) as output:
        colors = []
        data = [[183.32], [231.23], [16.43], [50.21], [508.97], [212.05], [1.0]]
        args = {
...
def test_chart_multiple_series_prints_correctly():
    with patch("sys.stdout", new=StringIO()) as output:
        colors = [91, 94]
        data = [
            [183.32, 190.52],
...
def test_chart_multiple_series_different_scale_prints_correctly():
    with patch("sys.stdout", new=StringIO()) as output:
        colors = [91, 94]
        data = [
            [183.32, 190.52],
...
def test_chart_stacked_prints_correctly():
    with patch("sys.stdout", new=StringIO()) as output:
        colors = [91, 94]
        data = [
            [183.32, 190.52],
...
def test_print_categories_prints_correct_categories():
    with patch("sys.stdout", new=StringIO()) as output:
...
def test_calendar_heatmap_prints_correct_heatmap():
    with patch("sys.stdout", new=StringIO()) as output:
        data = [
            [4.52],
            [4.81],
...
def test_calendar_heatmap_color_prints_correctly():
    with patch("sys.stdout", new=StringIO()) as output:
        data = [
            [4.52],
            [4.81],
...
def test_calendar_heatmap_custom_tick_prints_correctly():
    with patch("sys.stdout", new=StringIO()) as output:
        data = [
            [4.52],
            [4.81],
...
def test_calendar_heatmap_without_start_date_prints_correctly():
    with patch("sys.stdout", new=StringIO()) as output:
        data = [
            [4.52],
            [4.81],
